...
public class WeatherContract {
    ...
    // device.
    public static final String CONTENT_AUTHORITY = "com.makarfi.sunshine.app";
    ...
    /* Inner class that defines the content of the Location table */
    public static final class LocationEntry implements BaseColumns {
        ...
        // Location setting string is what will be sent to the openweathermap
        ...
        // Inorder to uniquely pinpoint the location on the map when we launch the
    ...
    /* Inner class that defines the content of the Weather table */
    public static final class WeatherEntry implements BaseColumns {
        ...
        // Date, stored as long in millisecs since the epoch
        ...
        // Min and max temperatures of the day stored as floats
        ...
        // Windspped is stored as a float representing windspeed mph
        public static final String COLUMN_WIND_SPEED = "windspeed";

        // Degrees are meteorological degrees (e.g 0 is north, 180 is south), stored as
        public static final String COLUMN_DEGREES = "degrees";

        // returns content://com.makarfi.sunshine.app/weather/{id}
