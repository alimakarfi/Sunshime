...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long rowId = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, data);
        Log.v(LOG_TAG, rowId+" Hi" );
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: data mismatch", cursor, data);
    ...
    public void testWeatherTable() {
        ...
        ContentValues data = TestUtilities.createWeatherValues(locationId);

        // Insert ContentValues into database and get a row ID back
        long rowID = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, data);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Error: failed", cursor, data);
        // Finally, close the cursor and database
        cursor.close();
        db.close();
    }
